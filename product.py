...
class ProductManagementSystem(tk.Toplevel):
    def __init__(self, parent, controller=None, show_only_list=False):
        ...
        self.show_only_list = show_only_list  # <-- Add this line
        self.create_widgets()
    ...
    def create_widgets(self):
        ...
        # --- NEW: If show_only_list, show only the product list tab and hide others ---
        if self.show_only_list:
            self.notebook.hide(1)  # Hide Order Management tab
            self.show_product_list()  # Show product list immediately
            # Optionally, disable product creation UI in setup_product_tab
            # You can also hide widgets in self.product_frame except the product list
